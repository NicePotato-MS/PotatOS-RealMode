...
VolumeLabel		db "SnoopOS    "; Volume Label: any 11 chars
FileSystem		db "FAT12   "	; File system type: don't change!

bootloader_start:
	mov ax, 07C0h			; Set up 512 bytes of stack space above buffer
...
; STRINGS AND VARIABLES
	...
	kern_filename	db "KERNEL  BIN"	; PotatOS kernel filename

	disk_error	db "Floppy error! Press any key...", 0
	file_not_found	db "Kernel is missing!", 0
